...
LOGGING_CONFIG = {
    ...
    'handlers': {
        ...
        'file.handler.contact_log': {
            'class': 'logging.handlers.RotatingFileHandler',
            'formatter': 'contact_log',
            'filename': os.path.abspath(os.path.join(Config.LOG_DIR, 'contact_log.log')),
            'maxBytes': 10000000,
            'backupCount': 5,
        },
    },
    'loggers': {
        ...
        'contact_log': {  # if __name__ == '__main__'
            'handlers': ['file.handler.contact_log'],
            'level': 'INFO',
            'propagate': False
        },
    }
